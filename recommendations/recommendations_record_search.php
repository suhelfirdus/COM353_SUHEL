        ...
        <div class="col-md-4">
            ...
            <form class="form-horizontal" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                ...
                <select name="searchparam" id="searchparam">
                    <option value="rec_id">Recommendation Id</option>
                    <option value="rec_name">Recommendation Name</option>
                    <option value="rec_date">Recommendation Date</option>
...
if (isset($_POST['SEARCH_PERSON'])) {
    ...
    $query = "select * from recommendations_det_view where ".$searchparam." like '%".$searchvalue."%'";
    echo $query;
    global $db;
