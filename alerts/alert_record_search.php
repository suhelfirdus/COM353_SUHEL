        ...
        <div class="col-md-4">
            ...
            <form class="form-horizontal" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                ...
                <select name="searchparam" id="searchparam">
                    ...
                    <option value="alert_desc">Alert Description</option>
                    <option value="alert_date_time">Alert Date Time</option>
                </select>
                </div>
                <div class="form-group">
                ...
                <button type="submit" class="btn btn-primary" name="SEARCH_ALERT" >
                    SEARCH
...
<?php
if (isset($_POST['SEARCH_ALERT'])) {
    $searchparam=e($_POST['searchparam']);
    $searchvalue=e($_POST['searchvalue']);
    $query = "select * from alerts_view where ".$searchparam." like '".$searchvalue."%'";
    //echo $query;
    global $db;
